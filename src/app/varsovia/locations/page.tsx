...
function liveChildPath(slug: string) {
  const base = IA_HUB_PATHS[HUB_KEY] || "/locations";
  return `${base}/${slug}`;
}
...
export default function VarsoviaLocationsPage() {
  ...
  useRegisterCmsFlush("ia-child:locations", modal !== null, () => onSubmit());
                ...
                >
                  <div className="relative h-36 w-full bg-[#F3F4F6]">
                    <AdminImage
                      ...
                      fallbackSrcs={[resolveAdminMediaPreviewUrl("/home/contact/contact-1.jpg")]}
                    />
                    <span
