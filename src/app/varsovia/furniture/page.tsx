...
function liveChildPath(slug: string) {
  const base = IA_HUB_PATHS[HUB_KEY] || "/furniture";
  return `${base}/${slug}`;
}
...
export default function VarsoviaFurniturePage() {
  ...
  const persistChildren = async (nextChildren: IaChildRow[]) => {
    ...
    try {
      ...
      toast.success("Furniture sub-page saved");
    } catch (err) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              placeholder="Search furniture sub-pages…"
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-[#E2E5EA] bg-white p-8 sm:p-12 text-center">
            ...
            <p className="text-sm text-[#6B7280]">No furniture sub-pages yet</p>
          </div>
        ) : (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-lg font-semibold text-[#1A2332]">
                {modal === "create" ? "Add Furniture sub-page" : "Edit Furniture sub-page"}
              </h2>
