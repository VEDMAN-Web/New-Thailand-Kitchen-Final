...
function liveChildPath(slug: string) {
  const base = IA_HUB_PATHS[HUB_KEY] || "/for-developers";
  return `${base}/${slug}`;
}
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              placeholder="Search for developers sub-pages…"
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-[#E2E5EA] bg-white p-12 text-center">
            ...
            <p className="text-sm text-[#6B7280]">No for developers sub-pages yet</p>
          </div>
        ) : (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-lg font-semibold text-[#1A2332]">
                {modal === "create" ? "Add For Developers sub-page" : "Edit For Developers sub-page"}
              </h2>
