          ...
          {showSkeleton
            ? [0, 1, 2].map((index) => (
                ...
                >
                  ...
                  <div className="mt-2 sm:mt-4 h-4 w-2/3 rounded bg-[#E8E4DC]" />
                </div>
              ))
            ...
            return (
              ...
              >
                ...
                <p
                  className={`mt-2 sm:mt-4 text-xs sm:text-base font-bold uppercase tracking-[0.08em] text-[#1A1A1A] transition-opacity duration-500 ${
